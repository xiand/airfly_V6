#ifdef BSP_FMC_IO_EXT_H_
#define BSP_FMC_IO_EXT_H_

/*
	安福莱STM32-V6   开发板扩展口线分配：总线地址 = 0x6820 0000
	D0  - GPRS_RERM_ON
	D1  - GPRS_RESET
	D2  - NRF24L01_CE
	D3  - NRF905_TX_EN
...
extern __IO uint32_t g_HC574_data;  //地址数据设置
